...
export default function OrganizadorComponent29() {
    const productos = [
        {
            img: '/organizador/condimentero2.png',
            referencia: 'Condimentero Vidrio',
            unidades: '1 UNIDAD',
            titulo: 'Condimentero Vidrio Montaje Bajo 3 Niveles',
            detalles: [
                { label: 'Tipo', value: 'Condimentero' },
                { label: 'Tamaño Gabinete', value: '20cm' },
                { label: 'Tamaño Del Artículo', value: 'Ancho: 25cm' },
                { label: 'Altura', value: '49.5cm' },
                { label: 'Profundidad', value: '42.5cm' },
        ...
        },
        {
            ...
            detalles: [
                ...
                { label: 'Tamaño Del Artículo', value: 'Ancho: 19cm' },
                { label: 'Altura', value: '49.5cm' },
                { label: 'Profundidad', value: '42.5cm' },
                { label: 'Marca', value: 'MZ' }
            ]
