...
export default function BisagrasContent2({
  mainImage = '/bisagras/bisagra2.png',
  sketchImage = '/fichastecnicas/fichatecnica2.png',

  productTitle = 'Bisagra SemiParche 35 mm',
  tipo = 'Bisagra Semiparche niquelada',
      ...
      <div className="product-body">
        ...
        <div className="product-data-table">
          ...
          <div className="product-sketch">
            <Image
              src={sketchImage}
              alt="Plano técnico de bisagra semiparche"
              width={600}
              height={400}
