...
export default function BisagrasContent6({
  mainImage = '/bisagras/bisagra6.png',
  sketchImage = '/fichastecnicas/fichatecnica6.png',

  productTitle = 'Bisagra 3D Negra Parche/Semiparche 35mm',
    ...
    <section className="bisagra-wrapper">
      ...
      <div className="product-body">
        <div className="product-image-left">
          <Image
            src={mainImage}
            alt="Bisagra 3D Negra Parche/Semiparche"
            width={300}
            height={300}
