...
export default function BrazosComponent17({
    mainImage = '/BrazosNeumaticos/BrazoNeumatico17.png',
    sketchImage = '/BrazosNeumaticos/fichatecnica17.png',

    productTitle = 'Brazo Soporte Blanco Doble\nPuerta Graduable ST',
    tipo = 'Brazo Soporte',
    ...
    empaque = '5 UNIDADES',
    codigo = 'Herraje-Brazos Neumaticos/017',
}) {
    useEffect(() => {
        ...
        <section className="bisagra-wrapper-BrazoNeumatico">
            ...
            <div className="product-body-BrazoNeumatico">
                ...
                <div className="product-image-left-BrazoNeumatico">
                    <Image
                        src={mainImage}
                        alt="Brazo Soporte Blanco Doble Puerta"
                        width={400}
                        height={400}
