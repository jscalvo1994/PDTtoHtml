...
export default function BrazosComponent14({
    mainImage = '/BrazosNeumaticos/BrazoNeumatico14.png',
    sketchImage = '/BrazosNeumaticos/fichatecnica14.png',

    productTitle = 'Brazo Neumático Cierre\nLento 60,80,100,120 Newtons',
    ...
    codigo = 'Herraje-Brazos Neumaticos/014',
}) {
    useEffect(() => {
        ...
        <section className="bisagra-wrapper-BrazoNeumatico">
            ...
            <div className="product-body-BrazoNeumatico">
                ...
                <div className="product-image-left-BrazoNeumatico">
                    <Image
                        src={mainImage}
                        alt="Brazo Neumático Cierre Lento"
                        width={400}
                        height={400}
