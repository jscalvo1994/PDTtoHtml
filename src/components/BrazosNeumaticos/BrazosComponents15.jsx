...
export default function BrazosComponent15({
    mainImage = '/BrazosNeumaticos/BrazoNeumatico15.png',
    sketchImage = '/BrazosNeumaticos/fichatecnica15.png',

    productTitle = 'Brazo Soporte Doble Puerta\nGraduable ST',
    tipo = 'Brazo Soporte',
    unidadEmpaque = '5 Unidades',
    suministro = 'Kit de montaje',
    cicloApertura = '60,000',
    altoModulo = 'Capacidad de carga: 45Kg',
    marca = 'MZ',

    referencia = 'Brazo Soporte',
    empaque = '5 UNIDADES',
    codigo = 'Herraje-Brazos Neumaticos/015',
}) {
    useEffect(() => {
        ...
        <section className="bisagra-wrapper-BrazoNeumatico">
            ...
            <div className="product-body-BrazoNeumatico">
                ...
                <div className="product-image-left-BrazoNeumatico">
                    <Image
                        src={mainImage}
                        alt="Brazo Soporte Doble Puerta"
                        width={400}
                        height={400}
